...
theorem add_left_cancel {a b c : R} (h : a + b = a + c) : b = c := by
  rw [← add_neg_cancel_right b a, add_comm b a, h, add_comm a c, add_neg_cancel_right c a]
...
theorem neg_eq_of_add_eq_zero {a b : R} (h : a + b = 0) : -a = b := by
  rw [← add_zero a, ← add_neg_cancel b, neg_add, neg_add, ← add_assoc, ← neg_add, h, add_comm, neg_neg, neg_zero, add_zero]

theorem eq_neg_of_add_eq_zero {a b : R} (h : a + b = 0) : a = -b := by
  rw [← add_zero a, ← add_neg_cancel b, ← add_assoc, h, add_comm, add_zero]
...
theorem neg_neg (a : R) : - -a = a := by
  rw [← add_zero (-a), neg_add, neg_zero, ← sub_self a, sub_eq_add_neg, add_comm (a) (-a), neg_add_cancel_left]
